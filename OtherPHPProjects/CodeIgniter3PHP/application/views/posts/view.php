...
<!-- only the original author should be able to delete or edit their own post -->
<?php if ($this->session->userdata('user_id') == $post['user_id']): ?>
    <hr>
    <!-- pull-left is bootstrap for float left -->
    <a class="btn btn-default pull-left"
       href="<?php echo base_url(); ?>posts/edit/<?php echo $post['slug']; ?>">Edit</a>
    <!-- we use form_open from php and close with an html </form> -->
