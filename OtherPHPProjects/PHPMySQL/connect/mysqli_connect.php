...
as is needed.
GRANT INSERT, SELECT, DELETE, UPDATE ON derekbanas.*
...
//Named after the creator of the tutorial who called his original database "students"
DEFINE('DB_NAME', 'derekbanas');
