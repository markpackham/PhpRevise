...
class CollectionTest extends \PHPUnit\Framework\TestCase {
	...
	//Make sure an empty collection returns no items
	public function empty_init_collection_returns_no_items() {
	...
	public function returns_json_encoded_items() {
		...
		//sadly assertInternalType is depricated
	...
	/** @test */
	//this is impossible to do without implementing JsonSerializable
